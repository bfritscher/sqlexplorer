...
--
-- Name: mpe_sql101; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE mpe_sql101 WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
