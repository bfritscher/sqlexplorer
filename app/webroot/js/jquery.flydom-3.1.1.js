...
jQuery.fn.createAppend = function(element, attrs, content)
{
    ...
    if (/*jQuery.browser.msie && */parentElement.nodeName.toLowerCase() == 'table' && element.nodeName.toLowerCase() == 'tr') {
    	...
    	//first tr as a thead
    	if (parentElement && parentElement.getElementsByTagName('thead')[0]) {
            ...
            // Create a new thead
            var thead = parentElement.appendChild(document.createElement('thead'));
            // Append our TR to our Thead and continue
            var element = thead.appendChild(element);
