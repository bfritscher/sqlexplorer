...
<div class="slide">
	...
	<p class="sql incremental" id="q<?php echo $question['id']?>">SELECT 
	
	</p>
	<div style="display:none;" id="q<?php echo $question['id']?>_sol"><?php echo nl2br($question['sql']);?></div>
	<input type="hidden" name="assignment" value="<?php echo $question['assignment_name'];?>" />
	<span class="view_schema"><a href="nojs.html" class="schema_link">schéma</a> <a class="solution_link" href="q<?php echo $question['id']?>">solution</a></span>
