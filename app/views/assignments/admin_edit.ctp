...
<?php echo $this->Form->create('Assignment', array('type' => 'file'));?>
	<fieldset>
 		<legend><?php __('Admin Edit Assignment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Assignment.name')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Assignment.name'))); ?></li>
